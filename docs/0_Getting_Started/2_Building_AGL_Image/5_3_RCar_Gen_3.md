  ...
  * Configuring U-Boot Parameters
    ...
    4. Depending on the board type, the BSP version, and the existence of
      a Kingfisher board :
        ...
        * h3ulcb : `$ setenv load_dtb ext4load mmc 0:1 0x48000000 /boot/r8a7795-es1-h3ulcb.dtb`

        * m3ulcb: `$ setenv load_dtb ext4load mmc 0:1 0x48000000 /boot/r8a7796-m3ulcb.dtb`

        * m3ulcb with a Kingfisher board: `$ setenv load_dtb ext4load mmc 0:1 0x48000000 /boot/r8a7796-m3ulcb-kf.dtb`

        * h3ulcb with a Kingfisher board: `$ setenv load_dtb ext4load mmc 0:1 0x48000000 /boot/r8a7795-es1-h3ulcb-kf.dtb`
